...
# Summons armourstand at player position
execute if entity @e[type=minecraft:mannequin,tag=manniclone] run execute at @s as @n[type=minecraft:mannequin,tag=manniclone] if score @s manniclonesId = @p cloneId run summon minecraft:mannequin ~ ~ ~ {PortalCooldown:0,Tags:["manniclone","none"]}
