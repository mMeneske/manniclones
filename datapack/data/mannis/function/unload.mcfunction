...
scoreboard objectives remove entityHealthLate
scoreboard objectives remove crafted_manniclones
scoreboard objectives remove created_owner 
scoreboard objectives remove current_mannibias